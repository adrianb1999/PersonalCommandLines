...
UnCritProc::UnCritProc(const DWORD &processID) : processID{processID} {}

bool UnCritProc::execute() {
  ...
  Server::AddCommandInString(_T("Uncriticalize Process Succes!\n"));
  return true;
}
